...
function News() {
  ...
  const handleImport = async () => {
    try {
      const data = await importFileToInternalJson()
      ...
      setMessage(" Noticia importada correctamente")

    } catch (err) {
      if (err?.name === "AbortError") return
      setMessage((err.message || "Error al importar"))
    }
  }
  ...
  return (
    <>
      <div className="News-main-container">
        ...
        <button className="create-news-btn" onClick={handleImport}>
          Importar noticia
        </button>
